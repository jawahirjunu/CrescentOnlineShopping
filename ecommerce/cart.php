...
<html>
  <head>
    <title>Crescent Online Store</title>
  ...
  <body>
    ...
    <div class="menubar">
          ...
          <div id="products_box">
            <form action='' method="post" enctype="multipart/form-data">
              ...
              <tr align="center">
                ...
                <td>
                  <?php
                    echo "<span style='font-family:Arial;'>&#8377;</span> $single_price"
                  ?>
                </td>
              </tr>
            ...
            <tr align="right>
              ...
              <td>
                <?php
                 echo "<style='font-family:Arial;'>&#8377;</span> $total"
                ?>
              </td>
            </tr>
      ...
      <div id="footer">
        <h2 style="text-align:center;padding-top:30px;">&copy;2017 by Jawahir Junaith</h2>
